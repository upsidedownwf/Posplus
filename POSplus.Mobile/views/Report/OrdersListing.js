POSplus.OrdersListing = function (params) {
    "use strict";
    ...
    function getDataGridInstance() {
        return $("#orderlistinggrid").dxDataGrid("instance");
    }
    function getorderlisting() {
        ...
        if (periodFrom != "" && periodTo!= "") {
            ...
            $.ajax(
                {
                    url: rooturl + "Reports/GetOrdersListing/" + token + "?EmployeeID=" + username.cAgentName,
                    type: "POST",
    ...
    return {
        getorderlisting: getorderlisting,
        Indicator: Indicator
    };
};