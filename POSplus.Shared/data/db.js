...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(POSplus.config.endpoints);
    var serviceConfig = $.extend(true, {}, POSplus.config.services, {
        db: {
    ...
    POSplus.db = new DevExpress.data.ODataContext(serviceConfig.db);
